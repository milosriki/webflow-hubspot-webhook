  ...
  try {
    ...
    const hubspotData = {
      properties: {
        ...
        phone: formData.phone || formData.Phone || formData.phoneNumber || formData.phone_number || formData.PhoneNumber || formData.phonenumber || formData.mobile || formData.mobilephone || '',
